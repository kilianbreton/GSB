...
$this->services['App\Controller\MainController'] = $instance = new \App\Controller\MainController(($this->privates['App\Repository\PraticienRepository'] ?? $this->load('getPraticienRepositoryService.php')));
