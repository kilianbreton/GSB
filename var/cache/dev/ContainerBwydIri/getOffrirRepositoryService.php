...
// Returns the private 'App\Repository\OffrirRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\OffrirRepository.php';

return $this->privates['App\Repository\OffrirRepository'] = new \App\Repository\OffrirRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
