...
// Returns the private 'App\Repository\RapportVisiteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\RapportVisiteRepository.php';

return $this->privates['App\Repository\RapportVisiteRepository'] = new \App\Repository\RapportVisiteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
